...
// in simulator we redefine to format for Nazarett_Gerardo_Project3 Developer console
...
{\
	NSString * exceptionName = [@"org.nazarett_gerardo_project3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nazarett_gerardo_project3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINazarett_Gerardo_Project3NativeItemNone = -1, 
	UINazarett_Gerardo_Project3NativeItemSpinner = -2,
	UINazarett_Gerardo_Project3NativeItemProgressBar = -3,
	
	UINazarett_Gerardo_Project3NativeItemSlider = -4,
	UINazarett_Gerardo_Project3NativeItemSwitch = -5,
	UINazarett_Gerardo_Project3NativeItemMultiButton = -6,
	UINazarett_Gerardo_Project3NativeItemSegmented = -7,
	
	UINazarett_Gerardo_Project3NativeItemTextView = -8,
	UINazarett_Gerardo_Project3NativeItemTextField = -9,
	UINazarett_Gerardo_Project3NativeItemSearchBar = -10,
	
	UINazarett_Gerardo_Project3NativeItemPicker = -11,
	UINazarett_Gerardo_Project3NativeItemDatePicker = -12,
	
	UINazarett_Gerardo_Project3NativeItemInfoLight = -13,
	UINazarett_Gerardo_Project3NativeItemInfoDark = -14,
	
	UINazarett_Gerardo_Project3NativeItemDisclosure = -15,
	
	UINazarett_Gerardo_Project3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Nazarett_Gerardo_Project3 instances of
