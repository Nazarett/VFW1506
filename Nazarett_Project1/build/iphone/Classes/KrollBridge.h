...
@interface Nazarett_Project1Object : KrollCoverageObject {
#else
@interface Nazarett_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Nazarett_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Nazarett_Project1Object *_nazarett_project1;
    KrollObject* console;
	BOOL shutdown;
