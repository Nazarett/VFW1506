...
//@interface titleproject3Object : NSObject
//@end

@interface titleproject3Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[titleproject3Object class]])
		{
			for (NSString *key in [[(titleproject3Object*)o modules] allKeys])
			{
