...
@interface titleproject3Object : KrollCoverageObject {
#else
@interface titleproject3Object : KrollObject {
#endif
@private
...
extern NSString * titleproject3$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	titleproject3Object *_titleproject3;
    KrollObject* console;
	BOOL shutdown;
