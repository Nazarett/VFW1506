...
// in simulator we redefine to format for titleproject3 Developer console
...
{\
	NSString * exceptionName = [@"org.titleproject3." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titleproject3";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UItitleproject3NativeItemNone = -1, 
	UItitleproject3NativeItemSpinner = -2,
	UItitleproject3NativeItemProgressBar = -3,
	
	UItitleproject3NativeItemSlider = -4,
	UItitleproject3NativeItemSwitch = -5,
	UItitleproject3NativeItemMultiButton = -6,
	UItitleproject3NativeItemSegmented = -7,
	
	UItitleproject3NativeItemTextView = -8,
	UItitleproject3NativeItemTextField = -9,
	UItitleproject3NativeItemSearchBar = -10,
	
	UItitleproject3NativeItemPicker = -11,
	UItitleproject3NativeItemDatePicker = -12,
	
	UItitleproject3NativeItemInfoLight = -13,
	UItitleproject3NativeItemInfoDark = -14,
	
	UItitleproject3NativeItemDisclosure = -15,
	
	UItitleproject3NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all titleproject3 instances of
