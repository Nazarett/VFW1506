...
/**
 Base class for all titleproject3 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the titleproject3 view hierarchy (such as wrapped iOS UIViews) was touched.
