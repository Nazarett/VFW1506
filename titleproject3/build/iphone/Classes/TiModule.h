...
/**
 The base class for all titleproject3 modules
 */
...
/**
 titleproject3 Platform calls this method on startup.
 */
-(void)startup;

/**
 titleproject3 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 titleproject3 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 titleproject3 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 titleproject3 Platform calls this method on resume.
 @param sender The sender of the event.
 */
