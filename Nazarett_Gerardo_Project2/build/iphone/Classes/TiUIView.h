...
/**
 Base class for all Nazarett_Gerrdo_project2 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Nazarett_Gerrdo_project2 view hierarchy (such as wrapped iOS UIViews) was touched.
