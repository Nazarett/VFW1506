...
// in simulator we redefine to format for Nazarett_Gerrdo_project2 Developer console
...
{\
	NSString * exceptionName = [@"org.nazarett_gerrdo_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nazarett_gerrdo_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINazarett_Gerrdo_project2NativeItemNone = -1, 
	UINazarett_Gerrdo_project2NativeItemSpinner = -2,
	UINazarett_Gerrdo_project2NativeItemProgressBar = -3,
	
	UINazarett_Gerrdo_project2NativeItemSlider = -4,
	UINazarett_Gerrdo_project2NativeItemSwitch = -5,
	UINazarett_Gerrdo_project2NativeItemMultiButton = -6,
	UINazarett_Gerrdo_project2NativeItemSegmented = -7,
	
	UINazarett_Gerrdo_project2NativeItemTextView = -8,
	UINazarett_Gerrdo_project2NativeItemTextField = -9,
	UINazarett_Gerrdo_project2NativeItemSearchBar = -10,
	
	UINazarett_Gerrdo_project2NativeItemPicker = -11,
	UINazarett_Gerrdo_project2NativeItemDatePicker = -12,
	
	UINazarett_Gerrdo_project2NativeItemInfoLight = -13,
	UINazarett_Gerrdo_project2NativeItemInfoDark = -14,
	
	UINazarett_Gerrdo_project2NativeItemDisclosure = -15,
	
	UINazarett_Gerrdo_project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Nazarett_Gerrdo_project2 instances of
