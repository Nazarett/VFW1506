 ...
 * to send analytic data that can be viewed on the Nazarett_Gerrdo_project2 Dashboard.
 *
 * For information on getting started with Nazarett_Gerrdo_project2 Platform Services,
