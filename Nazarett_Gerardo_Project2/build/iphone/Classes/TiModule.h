...
/**
 The base class for all Nazarett_Gerrdo_project2 modules
 */
...
/**
 Nazarett_Gerrdo_project2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Nazarett_Gerrdo_project2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Nazarett_Gerrdo_project2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Nazarett_Gerrdo_project2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Nazarett_Gerrdo_project2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
