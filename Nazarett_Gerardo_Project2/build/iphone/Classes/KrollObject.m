...
//@interface Nazarett_Gerrdo_project2Object : NSObject
//@end

@interface Nazarett_Gerrdo_project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Nazarett_Gerrdo_project2Object class]])
		{
			for (NSString *key in [[(Nazarett_Gerrdo_project2Object*)o modules] allKeys])
			{
