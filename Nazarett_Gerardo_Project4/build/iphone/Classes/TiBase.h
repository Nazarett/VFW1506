...
// in simulator we redefine to format for Nazarett_Gerardo_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.nazarett_gerardo_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nazarett_gerardo_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINazarett_Gerardo_Project4NativeItemNone = -1, 
	UINazarett_Gerardo_Project4NativeItemSpinner = -2,
	UINazarett_Gerardo_Project4NativeItemProgressBar = -3,
	
	UINazarett_Gerardo_Project4NativeItemSlider = -4,
	UINazarett_Gerardo_Project4NativeItemSwitch = -5,
	UINazarett_Gerardo_Project4NativeItemMultiButton = -6,
	UINazarett_Gerardo_Project4NativeItemSegmented = -7,
	
	UINazarett_Gerardo_Project4NativeItemTextView = -8,
	UINazarett_Gerardo_Project4NativeItemTextField = -9,
	UINazarett_Gerardo_Project4NativeItemSearchBar = -10,
	
	UINazarett_Gerardo_Project4NativeItemPicker = -11,
	UINazarett_Gerardo_Project4NativeItemDatePicker = -12,
	
	UINazarett_Gerardo_Project4NativeItemInfoLight = -13,
	UINazarett_Gerardo_Project4NativeItemInfoDark = -14,
	
	UINazarett_Gerardo_Project4NativeItemDisclosure = -15,
	
	UINazarett_Gerardo_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Nazarett_Gerardo_Project4 instances of
