...
//@interface Nazarett_Gerardo_Project4Object : NSObject
//@end

@interface Nazarett_Gerardo_Project4Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Nazarett_Gerardo_Project4Object class]])
		{
			for (NSString *key in [[(Nazarett_Gerardo_Project4Object*)o modules] allKeys])
			{
