...
// in simulator we redefine to format for Nazarett_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.nazarett_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.nazarett_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UINazarett_Project1NativeItemNone = -1, 
	UINazarett_Project1NativeItemSpinner = -2,
	UINazarett_Project1NativeItemProgressBar = -3,
	
	UINazarett_Project1NativeItemSlider = -4,
	UINazarett_Project1NativeItemSwitch = -5,
	UINazarett_Project1NativeItemMultiButton = -6,
	UINazarett_Project1NativeItemSegmented = -7,
	
	UINazarett_Project1NativeItemTextView = -8,
	UINazarett_Project1NativeItemTextField = -9,
	UINazarett_Project1NativeItemSearchBar = -10,
	
	UINazarett_Project1NativeItemPicker = -11,
	UINazarett_Project1NativeItemDatePicker = -12,
	
	UINazarett_Project1NativeItemInfoLight = -13,
	UINazarett_Project1NativeItemInfoDark = -14,
	
	UINazarett_Project1NativeItemDisclosure = -15,
	
	UINazarett_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Nazarett_Project1 instances of
