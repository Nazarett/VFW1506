...
//@interface ImagePracticeObject : NSObject
//@end

@interface ImagePracticeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[ImagePracticeObject class]])
		{
			for (NSString *key in [[(ImagePracticeObject*)o modules] allKeys])
			{
