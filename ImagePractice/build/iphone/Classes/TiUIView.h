...
/**
 Base class for all ImagePractice views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the ImagePractice view hierarchy (such as wrapped iOS UIViews) was touched.
