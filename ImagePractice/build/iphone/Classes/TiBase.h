...
// in simulator we redefine to format for ImagePractice Developer console
...
{\
	NSString * exceptionName = [@"org.imagepractice." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.imagepractice";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIImagePracticeNativeItemNone = -1, 
	UIImagePracticeNativeItemSpinner = -2,
	UIImagePracticeNativeItemProgressBar = -3,
	
	UIImagePracticeNativeItemSlider = -4,
	UIImagePracticeNativeItemSwitch = -5,
	UIImagePracticeNativeItemMultiButton = -6,
	UIImagePracticeNativeItemSegmented = -7,
	
	UIImagePracticeNativeItemTextView = -8,
	UIImagePracticeNativeItemTextField = -9,
	UIImagePracticeNativeItemSearchBar = -10,
	
	UIImagePracticeNativeItemPicker = -11,
	UIImagePracticeNativeItemDatePicker = -12,
	
	UIImagePracticeNativeItemInfoLight = -13,
	UIImagePracticeNativeItemInfoDark = -14,
	
	UIImagePracticeNativeItemDisclosure = -15,
	
	UIImagePracticeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all ImagePractice instances of
