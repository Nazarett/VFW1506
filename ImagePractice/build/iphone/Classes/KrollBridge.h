...
@interface ImagePracticeObject : KrollCoverageObject {
#else
@interface ImagePracticeObject : KrollObject {
#endif
@private
...
extern NSString * ImagePractice$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	ImagePracticeObject *_imagepractice;
    KrollObject* console;
	BOOL shutdown;
