...
//Rare exceptions to indicate a bug in the _imagepractice code (Eg, function that a subclass should have implemented)
...
/**
 The base class for ImagePractice proxies.
 */
